...
#     # Print the extracted details
#     if medications:
#         with open("C:\\Users\\krava\\OneDrive\\UBCV\\HACKATHON\\nwHacks2025-1\\frontend\\src\\text.txt","w") as f:
#             for med in medications:
#                 f.write(f"Medication Name: {med['medication_name']}\n")
#                 print(f"Medication Name: {med['medication_name']}")
...
#         print(f"Frequency: {med['frequency']}")
#         print()
#         medication_info = { 'medication_name':med['medication_name'] , 'dosage': med['dosage'], 'frequency': med['frequency'] }
#         med_info.append(medication_info)
    
#     print(f"med_info:{med_info}\n")
#     print()
